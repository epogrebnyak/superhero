...
Руководители бизнеса, у которых есть вопросы по анализу данных и автоматизации бизнес-процессов 
...
- Мы составили список из трех видео и прокомментировали их ([первая часть документа][part1]) 
- Мы составили список тем и вопросов, важных при орагниазации работы с данными и автоматизации ([вторая часть документа][part2]) 

### Как пользоваться

- [посмотреть видео][part1]
- [изучить вопросы][part2]
- [скажите, зацепило ли вас что-то](mailto:e.pogrebnyak@gmail.com)
...
- метафора тазика и драги на золоторудном месторождении
...
### Mindset - 1 (как сейчас):

- видят ли клиента, для всех ли он один
- как организуют отчетность 
- оценка положения на рынке (только одни мы такие, догонем кого-то, )
...
- Кейс: [сколько человек должны знать SQL в органиазции](https://twitter.com/chrisalbon/status/1254802082101489664?s=20)


### Mindset - 2 (что делать):
