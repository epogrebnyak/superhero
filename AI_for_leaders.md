...
*Для кого полезно:* руководители среднего бизнеса, у которых назрели вопросы по анализу данных и автоматизации бизнес-процессов

*История вопроса:*

- коллеги нас спросили, какие видео можно посмотреть руководителю, чтобы лучше понимать, что происходит в data science
...
- есть вообще цифровая составляющая в продукте?
- build vs buy vs buy и допилить
- "вообще-то у нас 1С стоит", "мы переходим на SAP" ()
