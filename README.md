...
> Люди из бизнеса, прошедшие дополнительный цикл (пере)подготовки в области программирования, разработки и ИТ архитектуры, становятся более качественными участниками команд и заказчиками ИТ-услуг, что повышает эффективность бизнеса компании или организации в целом.
