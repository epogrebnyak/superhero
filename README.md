...
Аудитория - бизнес-аналитики, которые рабоают в сферах:
- связь стратегии и ИТ систем
- подготовки и руководства проектами
- управление на основе данных и data governance

Подробнее о преподавании этих тем - [см. тут](intro.md).
